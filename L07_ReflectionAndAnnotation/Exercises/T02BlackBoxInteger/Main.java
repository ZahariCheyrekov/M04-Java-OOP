package M04_JavaOOP.L07_ReflectionAndAnnotation.Exercises.T02BlackBoxInteger;
...
public class Main {
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException,
        ...
        while (!"END".equals(input)) {
            ...
            Method method = clazz.getDeclaredMethod(methodName, int.class); //get method from
            // BlackBoxInt by its name and arguments(signature)
